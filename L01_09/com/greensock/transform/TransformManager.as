 ...
 *  
 * <b>A note about using fl.controls.* Flash components like TextArea and TextInput:</b> Due to the fact that 
 ...
 * and adding a RENDER event listener that calls drawFocus(false) on your TextArea/TextInput instance like this:
<listing version="3.0">
 ...
 * 
 * TransformManager attempts to automatically determine whether or not it is being used inside of 
 ...
 * object like <code>var manager:TransformManager = new TransformManager({flexMode:false});</code> (added in version 1.955)
 * 
 ...
 */
	public class TransformManager extends EventDispatcher {
		/** @private **/
		public static const VERSION:Number = 1.961;
		/** Normal scale mode **/
...
//---- SELECTION ---------------------------------------------------------------------------------------------------------------------
		 ...
		 * offset it by 40 pixels on the x-axis and 0 pixels on the y-axis, I'd do:<br /><br /><code>
		 * 
		 * myManager.addSelectionBoxElement(deleteButton, "topRight", 40, 0);</code>
		 * 
		 ...
		 */
		public function addSelectionBoxElement(element:DisplayObject, alignment:String="topRight", xOffset:Number=0, yOffset:Number=0):void {
			...
			_selectionElements.push( {element:element, alignment:alignment, angle:Math.atan2(yOffset, xOffset), length:Math.sqrt(xOffset * xOffset + yOffset * yOffset)} );
			if (_selection != null) {
...
//---- CURSOR FUNCTIONS ----------------------------------------------------------------------------------------------------------
		 ...
		 * Mouse instead of replacing it, you could do this:<br /><br /><code>
		 * 
		 * TransformManager.customizeMoveCursor(null, false, 20, 24);</code>
		 * 
		 ...
		 * Mouse instead of replacing it, you could do this:<br /><br /><code>
		 * 
		 * TransformManager.customizeScaleCursor(null, false, 16, 26, false);</code>
		 * 
		 ...
		 * Mouse instead of replacing it, you could do this:<br /><br /><code>
		 * 
		 * TransformManager.customizeRotationCursor(null, false, 15, 21, false);</code>
		 * 
		...
		public static var currentCursorRotation:Number;
		/** @private **/
		private function swapCursorIn(cursor:CustomCursor, handle:Object):void {
			if (_currentCursor != cursor && _stage != null) {
				...
				if (handle != null && _currentCursor.autoRotate) {
					...
					currentCursorRotation=handle.cursorRotation
				}
...
//---- GETTERS / SETTERS -----------------------------------------------------------------------------------------------------
		...
		public static function get currentCursor():Shape {
			if(_currentCursor){
				return _currentCursor.shape;
			}
			return null;
		}
