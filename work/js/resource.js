export let Resource = {
    ...
    tree: {
        path: {start: {x: -230, y: 497}, end: {x: -230, y: -7}}, metrics: {
            width: 615, height: 664
        }, src: 'images-startup/tree.png'
    },
    leftTxt: {
        path: {start: {x: -338, y: 15}, end: {x: 135, y: 27}}, metrics: {
            width: 335, height: 178
        }, src: 'images-startup/left-txt.png'
    },
    rightTxt: {
        path: {start: {x: 604, y: 0}, end: {x: 346, y: 107}}, metrics: {
            width: 195, height: 150
        }, src: 'images-startup/right-txt.png'
    },
    moveTxt: {
        path: {start: {x: 604, y: 0}, end: {x: 346, y: 207}}, metrics: {
            width: 312, height: 92
        }, src: 'images-startup/move-txt.png'
    },
    logo: {
        path: {start: {x: -10, y: -105}, end: {x: 27, y: 10}}, metrics: {
            width: 120, height: 120
        }, src: 'images-startup/logo.png'
    },
    bird: {
        path: {start: {x: 585, y: 30}, end: {x: 500, y: 58}},
        metrics: {
            width: 85, height: 116
        },
